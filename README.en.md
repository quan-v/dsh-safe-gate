...
It doesn't decide for you — it gives you two checks up front:
...
| **Version jump** | Large version jumps on self-update (`0.x`-aware), warn before a breaking update | warn |
